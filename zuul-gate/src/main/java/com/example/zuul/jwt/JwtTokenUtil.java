...
public class JwtTokenUtil implements Serializable {
    ...
    private static final long serialVersionUID = 703212736368081641L;
    ...
    public Boolean validateToken(String token, UserForAuth info) {
